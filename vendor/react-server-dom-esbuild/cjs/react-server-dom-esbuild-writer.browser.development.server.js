 ...
 * react-server-dom-esbuild-writer.browser.development.server.js
 *
...
function renderToReadableStream(model, esbuildMap) {
  var request;
  return new ReadableStream({
    start: function (controller) {
      request = createRequest(model, controller, esbuildMap);
      startWork(request);
    },
