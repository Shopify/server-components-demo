 ...
 * react-server-dom-esbuild-writer.node.development.server.js
 *
...
function resolveModuleMetaData(config, moduleReference) {
  // TODO: this has to be rewritten to be more generic
  return {
...
function pipeToNodeWritable(model, destination, esbuildMap) {
  var request = createRequest(model, destination, esbuildMap);
